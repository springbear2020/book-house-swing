...
public class ReceiveByteData implements Runnable {
     ...
     * The file save path
     */
    private static String fileSavePath = FileUtil.getFileSavePath();
    ...
    public void run() {
        ...
        try {
            ...
            bufferedWriter.write("com.springbear.ebrss.Server have received your request, please start sending now");
            ...
            if (FileUtil.saveFileToDisk(fileData, fileSavePath)) {
                feedBack = "true";
                fileSavePath = FileUtil.getFileSavePath();
            }
